...
import { getAllAnonymous, getAllMessages, getDirectMessage, getRecentMessage, handleDMFileUpload, handlefileUpload } from "../controllers/messagesController";
...
router.route('/:senderId/:recipientId').get(getRecentMessage)
